...
<!-- Fixed navbar -->
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="page-header">
        <h2><span class="label label-default">User ${id} Details</span></h2>
      </div>
	...
	<ul>	
	 ...
	 <li><c:out value="${the_User.user_Name}" /></li>
	
	<li><c:out value="${the_User.user_CIN}" /></li>
	
	<li><c:out value="${the_User.user_Gender}"/></li>
	</ul>
