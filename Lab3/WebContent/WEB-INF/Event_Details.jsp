...
<!-- Fixed navbar -->
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="page-header">
        <h2><span class="label label-default">Event ${id} Details</span></h2>
      </div>
      <div class="row">
        <div class="col-md-6">
          <table class="table">
	...
	<li><c:out value="${event.personOfContact}" /></li>
	
	<li><a href="Each_User?id=${id}" > User contact information </a></li>
	
	<li><a href="Each_Organization?id=${id}"><c:out value="${event.organization} Organization" /></a></li>
